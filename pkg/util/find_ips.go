...
// FindFreeIPs increments ip and sees it does not resolve in the network
...
// FindFreeIPRange represent the IPs as strings
...
// ValidateIPRange checks if the given string is of ipRange format
